...
if __name__ == "__main__":
    ...
    parser.add_argument("fbp", type=argparse.FileType("rb"), help="FBP file to decode")
    parser.add_argument(
        "-o", "--output", type=argparse.FileType("wb"), help="resulting bmp"
    )
    parser.add_argument(
        "--palette", "-p", type=argparse.FileType("rb"), required=True, help="PAT file"
    )
    parser.add_argument(
        "--palette_id", "-i", type=argparse.FileType("rb"), default=0, help="PAT file"
    )
    parser.add_argument(
