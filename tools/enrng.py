...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="tool for converting GIF animation to RNG"
    )
    parser.add_argument("gif", type=argparse.FileType("rb"), help="gif file to encode")
    parser.add_argument(
        "-o",
        "--output",
        required=True,
    ...
    parser.add_argument(
        "--algorithm", "-a", required=True, help="decompression algorithm"
    )
    parser.add_argument(
        "-d",
    ...
    parser.add_argument(
        "--progress", "-P", action="store_true", default=False, help="show progress bar"
    )
